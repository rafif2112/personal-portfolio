...
const Terminal: React.FC = () => {
        ...
        newOutput.push({
          content: (
            <div className="">
              ...
              <p>Type {`"info"`} for a list of available commands</p>
            </div>
          ),
          id: Date.now(),
        });
  ...
  return (
    <div className="relative w-full overflow-hidden rounded-xl border bg-primary/80 font-firacode backdrop-blur-lg dark:bg-primary/50">
